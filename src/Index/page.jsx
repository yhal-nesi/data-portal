  ...
  render() {
    ...
    return (
      <div className='index-page'>
        <div className="agdr-index-header"></div>
        <div className="agdr-index-header__attribution">kākāpō chick <a target="_blank" href="https://www.flickr.com/photos/docnz/8528282263/">photo</a> by Dianne Mason, 2009 <a target="_blank" href="https://creativecommons.org/licenses/by/2.0/">CC2.0</a></div>
